...
import com.shital.myapplication.databinding.ActivityMainValidationBinding

class MainActivityValidation : AppCompatActivity()
{
    private lateinit var binding: ActivityMainValidationBinding

    override fun onCreate(savedInstanceState: Bundle?)
    {
        super.onCreate(savedInstanceState)
        binding = ActivityMainValidationBinding.inflate(layoutInflater)
